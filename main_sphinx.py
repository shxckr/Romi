...
try:
    from motor_driver_sphinx import motor_driver
    from encoder_sphinx import encoder
    from task_motor_sphinx import task_motor
    from task_user_sphinx import task_user
    from linesensors_sphinx import LineSensors
    from task_linefollow_sphinx import task_linefollow
    from task_share import Share, Queue
    from IMU_sphinx import IMU
    from task_imu_sphinx import task_imu
    from task_bumpsensor_sphinx import task_bumpsensor
    from task_observer_sphinx import task_observer
    from task_courseTest_sphinx import task_course
    from task_UserButton_sphinx import task_UButton
except Exception:
    pass
...
try:
    from pyb import Timer, Pin, USB_VCP, I2C, millis, delay
except Exception:
    class Timer:
