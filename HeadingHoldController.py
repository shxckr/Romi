class HeadingHoldController:
    def __init__(self, heading_share, initHeadSh, target_heading=180.0,
                 base_speed=180.0, kp=2.0, min_speed=100.0, max_speed=300.0):
...
# class HeadingHoldController:
#     def __init__(self, heading_share, initHeadSh, target_heading=180.0, base_speed=180.0,
#                  kp=2.0, min_speed=100.0, max_speed=300.0):
#         self.heading_share = heading_share
#         self.target_heading = target_heading
#         self.base_speed = base_speed
#         self.kp = kp
...
#     def get_wheel_speeds(self):
#         heading = self.heading_share.get() - self._initHeadSh.get()
#         error = self._wrap_angle(self.target_heading - heading)
#         correction = self.kp * error
